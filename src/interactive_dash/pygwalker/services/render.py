...
@lru_cache(maxsize=1)
def get_gwalker_script_base64() -> str:
    bundle_path = os.path.join(ROOT_DIR, "templates", "dist", "pygwalker-app.iife.js")
    with open(bundle_path, "r", encoding="utf8") as handle:
        return compress_data(handle.read())
